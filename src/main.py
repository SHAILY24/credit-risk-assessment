...
def main():
    ...
    explain_tree_model(rf_model, X_train, X_test, model_name='Random Forest', filename='rf_shap.png')
    explain_tree_model(gb_model, X_train, X_test, model_name='Gradient Boosting', filename='gb_shap.png')
    explain_deep_model(nn_model, scaler.transform(X_train), X_test_scaled, filename='nn_shap.png')
